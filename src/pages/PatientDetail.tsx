      ...
      <div className="bg-white dark:bg-[#102023] rounded-xl shadow-sm border border-gray-100 dark:border-[#224449] p-6 mb-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex gap-3 w-full md:w-auto">
             <button className="flex-1 md:flex-none px-6 py-2.5 rounded-lg bg-primary text-white font-bold hover:bg-primary/90 transition-colors shadow-lg shadow-primary/30">
                New Appointment
             </button>
          </div>
        </div>
